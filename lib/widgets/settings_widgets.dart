...
class GithubIcon extends StatelessWidget {
  const GithubIcon({super.key, this.size = 24, this.color = Colors.white});
...
class _GithubPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.cubicTo(2.22, 11.5, 1.82, 11.12, 2.49, 11.12);
    ...
    path.cubicTo(6.66, 3.95, 7.34, 3.86, 8, 3.86);
    path.cubicTo(8.66, 3.86, 9.34, 3.95, 9.98, 4.13);
    path.cubicTo(11.51, 3.1, 12.18, 3.31, 12.18, 3.31);
    path.cubicTo(12.62, 4.41, 12.34, 5.23, 12.26, 5.43);
    path.cubicTo(12.77, 5.99, 13.08, 6.71, 13.08, 7.58);
    path.cubicTo(13.08, 10.65, 11.21, 11.33, 9.43, 11.53);
    path.cubicTo(9.72, 11.78, 9.97, 12.26, 9.97, 13.01);
    path.cubicTo(9.97, 14.08, 9.96, 14.94, 9.96, 15.21);
    path.cubicTo(9.96, 15.42, 10.11, 15.67, 10.51, 15.59);
    path.cubicTo(13.71, 14.53, 16, 11.53, 16, 8);
