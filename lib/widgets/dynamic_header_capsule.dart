    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          // 1-Tap Quick Mode Switcher Segment
          Container(
            height: 32,
              ...
              children: [
                Expanded(
                  child: PressableScale(
                    onTap: () {
                      HapticFeedback.selectionClick();
                      widget.onModeChanged?.call('single');
                    },
                    child: AnimatedContainer(
                      duration: const Duration(milliseconds: 150),
                      alignment: Alignment.center,
                      decoration: BoxDecoration(
                        color: widget.mode == 'single'
                            ? p.surface2
                            : Colors.transparent,
                        borderRadius: BorderRadius.circular(8),
                        boxShadow: widget.mode == 'single'
                            ? [
                                BoxShadow(
                      ...
                      child: Row(
                        ...
                        children: [
                          Icon(
                            ...
                            size: 13,
                            color: widget.mode == 'single' ? p.accent : p.text3,
                          ),
                          const SizedBox(width: 5),
                          Text(
                            'Single Mode'.localized(context),
                            style: TextStyle(
                              color: widget.mode == 'single' ? p.text : p.text3,
                              fontSize: 11.5,
                              fontWeight: widget.mode == 'single'
                                  ? FontWeight.w700
                                  : FontWeight.w500,
                            ),
                          ),
                ...
                Expanded(
                  child: PressableScale(
                    onTap: () {
                      HapticFeedback.selectionClick();
                      widget.onModeChanged?.call('two-way');
                    },
                    child: AnimatedContainer(
                      duration: const Duration(milliseconds: 150),
                      alignment: Alignment.center,
                      decoration: BoxDecoration(
                        color: widget.mode == 'two-way'
                            ? p.surface2
                            : Colors.transparent,
                        borderRadius: BorderRadius.circular(8),
                        boxShadow: widget.mode == 'two-way'
                            ? [
                                BoxShadow(
                                  color: Colors.black.withValues(alpha: 0.1),
                                  blurRadius: 3,
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          const SizedBox(width: 5),
                          Text(
                            'Two-Way Mode'.localized(context),
                            style: TextStyle(
                              color: widget.mode == 'two-way'
                                  ? p.text
                                  : p.text3,
                              fontSize: 11.5,
                              fontWeight: widget.mode == 'two-way'
                                  ? FontWeight.w700
                                  : FontWeight.w500,
                            ),
                          ),
