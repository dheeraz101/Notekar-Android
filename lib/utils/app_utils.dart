...
const feedbackProxyUrl = 'https://notekar-feedback-proxy.dheeraj8v.workers.dev';
const feedbackApiKey = String.fromEnvironment(
  'FEEDBACK_API_KEY',
  defaultValue: 'notekar-app-secret-feedback-key-2026',
);
