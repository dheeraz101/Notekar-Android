...
import 'package:notekar/dialogs/gravity_sandbox_dialog.dart';
    ...
    return Column(
      children: [
        ...
        SettingsGroup(
          ...
          children: [
            SettingsRow(
              ...
              subtitle: 'Accelerometer physics & bouncing orbs'.localized(
                context,
              ),
              status: 'Launch'.localized(context),
              color: const Color(0xFFFF007A),
              onTap: () => GravitySandboxDialog.show(context, p: p),
            ),
            SettingsRow(
              p: p,
        ...
        SettingsPageDescription(
          p: p,
          text:
              'Real-time accelerometer physics simulation and cryptographic sovereign tokens.'
                  .localized(context),
        ),
        ...
        SettingsGroup(
          ...
          children: [
            SettingsRow(
              ...
              title: 'Relock God Mode'.localized(context),
              subtitle: 'Hides God Mode until #godmode is entered again'
                  .localized(context),
              color: p.red,
              onTap: onRelockGodMode,
            ),
          ],
        ),
